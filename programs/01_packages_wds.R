...
pacman::p_load(tictoc, parallel, pbapply, future, 
               ...
               #textme, lodown,
               BiocManager, Polychrome, effects, janitor,
               ...
               latex2exp, igraph, httpgd, scales, lemon, beepr)
...
theme_customs <- function() {
  theme_minimal(base_family = "serif") +
    theme(panel.grid.minor = element_blank(),
          ...
          axis.ticks.length = unit(0.25, "cm")  # Modify length to your preference
...
theme_customs_map <- function() {
  theme_minimal(base_family = "IBM Plex Sans Condensed") +
    theme(panel.grid.major = element_blank(), 
          ...
          axis.ticks = element_line(color = "black"),
          axis.ticks.length = unit(0.25, "cm"),  # Modify length to your preference
          axis.ticks.margin = unit(0.5, "cm")  # Modify margin to your preference
          )
}
